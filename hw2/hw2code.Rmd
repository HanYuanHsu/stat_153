...
Below is the plot of the time series data:
```{r}
plot(t, y, type='l')
```
...
$$g(t) = \beta_0 + \beta_1t
+ \beta_2 \cos(2\pi f_1t) + \beta_3 \sin(2\pi f_1t)
+ \beta_4 \cos(2\pi f_2t) + \beta_5 \sin(2\pi f_2t)
+ \beta_6 \cos(2\pi f_3t) + \beta_7 \sin(2\pi f_3t).$$
